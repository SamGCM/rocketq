...
toggle.addEventListener('click', () => {
    ...
    if(mode.classList.contains('night-mode') == true){
        ...
        const btnOutilined = document.querySelectorAll('.outlined')
        ...
        btnOutilined.forEach(button => {
            button.style.setProperty('background', 'var(--white)')
            button.style.setProperty('color', 'var(--black)')
        })
